file(REMOVE_RECURSE "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads")

if(EXISTS "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads")

set(filename "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/apollo/voxnet/cmake-3.13.4/Tests/CMakeTests/uploads/file2.png"
